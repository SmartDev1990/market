      ...
      <div className={styles.profile}>
        <div className={styles.banner}>
          {loading ? (
            ...
            <img
              src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${bannerHash ||
                user.bannerHash}`}
        ...
        <div className={styles.wrapper}>
          <div className={styles.avatarWrapper}>
            {loading ? (
              ...
              <img
                src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${user.imageHash}`}
                        ...
                        activity.to ? (
                          ...
                          >
                            <div className={styles.ownerAvatarWrapper}>
                              {activity.image ? (
                                <img
                                  src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${activity.image}`}
