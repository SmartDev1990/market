      ...
      {loading ? (
        ...
        <div className={styles.inner}>
          {collections.map((collection, idx) => (
            ...
            >
              <img
                src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${collection.logoImageHash}`}
          ...
          <div className={styles.inputGroup}>
            ...
            <div className={styles.inputWrapper}>
              <div className={styles.logoUploadBox}>
                <img
                  src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${collections[index].logoImageHash}`}
                />
              </div>
            </div>
          </div>
