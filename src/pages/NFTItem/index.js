...
const CHAIN = ENV === 'MAINNET' ? 250 : 4002;
...
const NFTItem = () => {
  ...
  const isLoggedIn = () => {
    return account && (ENV === 'MAINNET' ? chainId === 250 : chainId === 4002);
  };
            ...
            {ownerInfoLoading || tokenOwnerLoading ? (
              ...
              <>
                <div className={styles.ownerAvatar}>
                  {ownerInfo?.imageHash ? (
                    <img
                      src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${ownerInfo.imageHash}`}
          ...
          <div className={styles.itemOwner}>
            <div className={styles.ownerAvatar}>
              {creatorInfo?.imageHash ? (
                <img
                  src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${creatorInfo.imageHash}`}
                  className={styles.avatar}
                />
              ) : (
                <Identicon
                        ...
                        <div className={styles.owner}>
                          <Link to={`/account/${listing.owner}`}>
                            <div className={styles.userAvatarWrapper}>
                              {listing.image ? (
                                <img
                                  src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${listing.image}`}
                                  className={styles.userAvatar}
                                />
                              ) : (
                                <Identicon
                            ...
                            <div className={styles.owner}>
                              <Link to={`/account/${offer.creator}`}>
                                <div className={styles.userAvatarWrapper}>
                                  {offer.image ? (
                                    <img
                                      src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${offer.image}`}
                                      className={styles.userAvatar}
                                    />
                                  ) : (
                                    <Identicon
                    ...
                    {history ? (
                      <Link to={`/account/${history.from}`}>
                        <div className={styles.userAvatarWrapper}>
                          {history.fromImage ? (
                            <img
                              src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${history.fromImage}`}
                              className={styles.userAvatar}
                            />
                          ) : (
                            <Identicon
                    ...
                    {history ? (
                      <Link to={`/account/${history.to}`}>
                        <div className={styles.userAvatarWrapper}>
                          {history.toImage ? (
                            <img
                              src={`https://tomato-tough-squid-756.mypinata.cloud/ipfs/${history.toImage}`}
                              className={styles.userAvatar}
                            />
                          ) : (
                            <Identicon
